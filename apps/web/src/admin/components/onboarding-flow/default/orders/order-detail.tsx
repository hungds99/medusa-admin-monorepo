  ...
  return (
    <>
      <Text size='small' className='mb-6'>
        You finished the setup guide 🎉 You now have your first order. Feel free to play around with
        the order management functionalities, such as capturing payment, creating fulfillments, and
        more.
      </Text>
      <Heading
        level='h2'
      ...
      <Text size='small'>
        Medusa is a completely customizable commerce solution. We've curated some essential guides
        to kickstart your development with Medusa.
      </Text>
        ...
        >
          <div className='p-3 rounded-rounded items-start flex bg-ui-bg-subtle shadow-elevation-card-rest hover:shadow-elevation-card-hover'>
            ...
            <div>
              ...
              <Text size='small'>
                Learn how to build a marketplace, subscription-based purchases, or your custom
                use-case.
              </Text>
            </div>
          </div>
        </a>
        <a href='https://docs.medusajs.com/beta/?ref=onboarding' target='_blank' className='flex'>
          <div className='p-3 rounded-rounded items-start flex bg-ui-bg-subtle shadow-elevation-card-rest hover:shadow-elevation-card-hover'>
            <div className='mr-4'>
              <div className='bg-ui-bg-base rounded-lg border border-ui-border-strong p-1 flex justify-center items-center'>
                <IconBadge>
