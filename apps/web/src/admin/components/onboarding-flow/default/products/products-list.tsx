...
const ProductsListDefault = ({ onNext, isComplete }: StepContentProps) => {
  ...
  return (
    <div>
      ...
      <Text>
        You can create a product by clicking the "New Product" button below. Alternatively, if
        you're not ready to create your own product, we can create a sample one for you.
      </Text>
      {!isComplete && (
