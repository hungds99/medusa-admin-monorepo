  ...
  return (
    <>
      <Text size='small' className='mb-6'>
        You finished the setup guide 🎉. You have now a complete ecommerce store with a backend,
        admin, and a Next.js storefront. Feel free to play around with each of these components to
        experience all commerce features that Medusa provides.
      </Text>
      <Heading
        level='h2'
      ...
      <Text size='small'>
        Your ecommerce store provides all basic ecommerce features you need to start selling. You
        can add more functionalities, add plugins for third-party integrations, and customize the
        ...
        >
          <div className='p-3 rounded-rounded flex items-start bg-ui-bg-subtle shadow-elevation-card-rest hover:shadow-elevation-card-hover'>
            ...
            <div>
              ...
              <Text size='small'>
                Install plugins for payment, fulfillment, search, and more, and integrate them in
                your storefront.
              </Text>
            </div>
          </div>
        ...
        >
          <div className='p-3 rounded-rounded items-start flex bg-ui-bg-subtle shadow-elevation-card-rest hover:shadow-elevation-card-hover'>
            ...
            <div>
              ...
              <Text size='small'>
                Learn about all available commerce features in Medusa and how to add them in your
                storefront
              </Text>
            </div>
          </div>
