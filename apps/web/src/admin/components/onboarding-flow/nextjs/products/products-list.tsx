...
import { useAdminCreateCollection, useAdminCreateProduct, useMedusa } from 'medusa-react';
...
const ProductsListNextjs = ({ onNext, isComplete }: StepContentProps) => {
  ...
  return (
    <div>
      <Text className='mb-2'>
        Products in Medusa represent the products you sell. You can set their general details
        including a title and description. Each product has options and variants, and you can set a
