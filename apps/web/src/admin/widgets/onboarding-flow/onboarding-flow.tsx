...
const OnboardingFlow = (props: OnboardingWidgetProps) => {
  ...
  const { data, isLoading } = useAdminCustomQuery<undefined, OnboardingStateRes>(
    '/onboarding',
    QUERY_KEY,
  );
  ...
  return (
    <>
      <Container
        className={clx('text-ui-fg-subtle px-0 pt-0 pb-4', {
          'mb-4': completed,
        })}
      >
        <Accordion
            ...
            {!completed ? (
                  ...
                  {!!currentStep ? (
                    <>
                      {currentStep === steps[steps.length - 1].id ? (
                        ...
                        <Button variant='secondary' size='base' onClick={() => onHide()}>
                          Cancel Setup
                        </Button>
                      )}
                    </>
                    ...
                    <>
                      ...
                      <Button variant='primary' size='base' onClick={() => onStart()}>
                        Begin setup
                      </Button>
                    </>
                  )}
              ...
              <>
                <div>
                  ...
                  <Text>
                    This whole experience was built using our new <strong>widgets</strong> feature.
                    <br /> You can find out more details and build your own by following{' '}
                    <a
